...
morten[morten.index > 5].plot(kind='bar', title='Person 1', x=names)
plt.savefig('morten.png')

arash[arash.index > 5].plot(kind='bar', title='Person 2', x=names)
plt.savefig('arash.png')

mikael[mikael.index > 5].plot(kind='bar', title='Person 3', x=names)
plt.savefig('mikael.png')

andreas[andreas.index > 5].plot(kind='bar', title='Person 4', x=names)
plt.savefig('andreas.png')