...
mqueue0 = ModuleQueue(0, 80, 3, work_array0, false);
mworker0 = ModuleWorker(0, 81, work_array0, ptime_array0);
mtransporter0 = ModuleTransporter(0, 82, ttime_array0, next_array0, false);
...
mqueue1 = ModuleQueue(1, 83, 3, work_array1, false);
mworker1 = ModuleWorker(1, 84, work_array1, ptime_array1);
mtransporter1 = ModuleTransporter(1, 85, ttime_array1, next_array1, false);
...
mqueue2 = ModuleQueue(2, 86, 3, work_array2, true);
mworker2 = ModuleWorker(2, 87, work_array2, ptime_array2);
mtransporter2 = ModuleTransporter(2, 88, ttime_array2, next_array2, true);
...
mqueue3 = ModuleQueue(3, 89, 3, work_array3, false);
mworker3 = ModuleWorker(3, 90, work_array3, ptime_array3);
mtransporter3 = ModuleTransporter(3, 91, ttime_array3, next_array3, false);
...
mqueue4 = ModuleQueue(4, 92, 3, work_array4, true);
mworker4 = ModuleWorker(4, 93, work_array4, ptime_array4);
mtransporter4 = ModuleTransporter(4, 94, ttime_array4, next_array4, true);
...
mqueue5 = ModuleQueue(5, 95, 3, work_array5, true);
mworker5 = ModuleWorker(5, 96, work_array5, ptime_array5);
mtransporter5 = ModuleTransporter(5, 97, ttime_array5, next_array5, true);

// Recipe 0
const node r0node0 = {0, 0, {2, -1, -1, -1, -1, -1, -1}, 1}; 
const node r0node1 = {2, 1, {3, -1, -1, -1, -1, -1, -1}, 1}; 
const node r0node2 = {3, 1, {4, -1, -1, -1, -1, -1, -1}, 1}; 
const node r0node3 = {4, 1, {5, -1, -1, -1, -1, -1, -1}, 1}; 
const node r0node4 = {5, 1, {6, -1, -1, -1, -1, -1, -1}, 1}; 
...
// Recipe 1
const node r1node0 = {0, 0, {2, -1, -1, -1, -1, -1, -1}, 1}; 
const node r1node1 = {2, 1, {3, -1, -1, -1, -1, -1, -1}, 1}; 
const node r1node2 = {3, 1, {4, -1, -1, -1, -1, -1, -1}, 1}; 
const node r1node3 = {4, 1, {5, -1, -1, -1, -1, -1, -1}, 1}; 
const node r1node4 = {5, 1, {6, -1, -1, -1, -1, -1, -1}, 1}; 
...
// Recipe 2
const node r2node0 = {0, 0, {2, -1, -1, -1, -1, -1, -1}, 1}; 
const node r2node1 = {2, 1, {3, -1, -1, -1, -1, -1, -1}, 1}; 
const node r2node2 = {3, 1, {4, -1, -1, -1, -1, -1, -1}, 1}; 
const node r2node3 = {4, 1, {5, -1, -1, -1, -1, -1, -1}, 1}; 
const node r2node4 = {5, 1, {6, -1, -1, -1, -1, -1, -1}, 1}; 
...
// Recipe 3
const node r3node0 = {0, 0, {2, -1, -1, -1, -1, -1, -1}, 1}; 
const node r3node1 = {2, 1, {3, -1, -1, -1, -1, -1, -1}, 1}; 
const node r3node2 = {3, 1, {4, -1, -1, -1, -1, -1, -1}, 1}; 
const node r3node3 = {4, 1, {5, -1, -1, -1, -1, -1, -1}, 1}; 
const node r3node4 = {5, 1, {6, -1, -1, -1, -1, -1, -1}, 1}; 
...
// Recipe 4
const node r4node0 = {0, 0, {2, -1, -1, -1, -1, -1, -1}, 1}; 
const node r4node1 = {2, 1, {3, -1, -1, -1, -1, -1, -1}, 1}; 
const node r4node2 = {3, 1, {4, -1, -1, -1, -1, -1, -1}, 1}; 
const node r4node3 = {4, 1, {5, -1, -1, -1, -1, -1, -1}, 1}; 
const node r4node4 = {5, 1, {6, -1, -1, -1, -1, -1, -1}, 1}; 
...
rid_t rqa[NUMBER_OF_RECIPES] = {0, 1, 2, 3, 4};
rqueue = RecipeQueue(rqa, 98);rem = Remover(99);
initer = Initializer();
urge = Urgent();
