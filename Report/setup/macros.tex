...
\newcommand\fs@simplerule{\def\@fs@cfont{\bfseries}\let\@fs@capt\floatc@simplerule
	\def\@fs@pre{\hrule height.8pt depth0pt \kern6pt}%
	\def\@fs@post{\kern4pt\hrule height.8pt depth0pt \kern6pt \relax}%
	\def\@fs@mid{\kern8pt}%
	\let\@fs@iftopcapt\iftrue}


\floatstyle{simplerule}
\newfloat{definition}{thp}{lop}[chapter]
\floatname{defintion}{Definition}
