...
painter = SquareModule(m_id='painter', wp_time={'paint': 10}, t_time=t, queue_length=queue_length)
...
jigsaw = SquareModule(m_id='jigsaw', wp_time={'saw': 20}, t_time=t, queue_length=queue_length)
buzzsaw = SquareModule(m_id='buzzsaw', wp_time={'saw': 20}, t_time=t, queue_length=queue_length)
